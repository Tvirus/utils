...
#define RIFF_TYPE_UNKNOWN           0
#define RIFF_TYPE_BUNDLE            1
#define RIFF_TYPE_DIB               2  /* RIFF Device Independent Bitmap */
#define RIFF_TYPE_MIDI              3  /* RIFF Musical Instrument Digital Interface */
#define RIFF_TYPE_MULTIMEDIA_MOVIE  4  /* RIFF Multimedia Movie */
#define RIFF_TYPE_PALETTE           5  /* Palette */
#define RIFF_TYPE_RICH_TEXT         6
#define RIFF_TYPE_WAVE              7  /* Waveform Audio */
#define RIFF_TYPE_AVI               8
#define RIFF_TYPE_CPPO              9
#define RIFF_TYPE_ANIMATED_CURSOR  10  /* Windows NT Animated Cursor */
...
#define WAVE_FORMAT_CU_CODEC                    0x0019  /*  HewlettPackard Company */
#define WAVE_FORMAT_HP_DYN_VOICE                0x001A  /* HewlettPackard Company */
...
/* For Raw AAC, with format block AudioSpecificConfig() (as defined by MPEG4), that follows WAVEFORMATEX */
...
#define WAVE_FORMAT_ILINK_VC                    0x0230  /* Ilink Worldwide */
...
/* Microsoft Corporation (MPEG4 Audio Transport Streams (LOAS/LATM) */
...
/* Microsoft Corporation (MPEG2 AAC or MPEG4 HEAAC v1/v2 streams with any payload (ADTS,ADIF,LOAS/LATM,RAW).
...
#define WAVE_FORMAT_MPEG4_AAC                   0xA106  /* ISO/MPEG4 */
...
} riff_wave_pcm_info_t;

typedef struct
{
    uint32_t format;  /* WAVE_FORMAT_ */
    uint32_t channels;
...
extern int riff_get_file_info(const uint8_t *data, size_t size, riff_info_t *info);
